...
namespace LogTest.Web.Menus;

public class LogTestMenuContributor : IMenuContributor
{
    ...
    {
        var l = context.GetLocalizer<LogTestResource>();
        ...
        context.Menu.AddItem(
            new ApplicationMenuItem(
                LogTestMenus.HostDashboard,
                l["Menu:Dashboard"],
                "~/HostDashboard",
                icon: "fa fa-line-chart",
                order: 2
            ).RequirePermissions(LogTestPermissions.Dashboard.Host)
        );

        //TenantDashboard
        context.Menu.AddItem(
            new ApplicationMenuItem(
                LogTestMenus.TenantDashboard,
                l["Menu:Dashboard"],
                "~/Dashboard",
                icon: "fa fa-line-chart",
                order: 2
            ).RequirePermissions(LogTestPermissions.Dashboard.Tenant)
        );
